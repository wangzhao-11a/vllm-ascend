...
class AscendDSAImpl(DSAAttentionImpl):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        hf_cfg = getattr(self.vllm_config.model_config, "hf_config", None) if self.vllm_config is not None else None
        self.use_index_cache: bool = self.skip_topk or bool(getattr(hf_cfg, "use_index_cache", False))
